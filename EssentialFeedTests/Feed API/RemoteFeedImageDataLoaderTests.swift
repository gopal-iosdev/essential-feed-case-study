...
//  EssentialFeedTests
//
//  Created by Gopal Gurram on 5/27/24.
//
...
final class RemoteFeedImageDataLoaderTests: XCTestCase {
    ...
    func test_loadImageDataFromURL_deliversConnectivityErrorOnClientError() {
        ...
        let clientError = NSError.anyError
    ...
    func test_loadImageDataFromURL_doesNotDeliverResultAfterSUTInstanceHasBeenDeallocated() {
        ...
        _ = sut?.loadImageData(from: URL.anyURL) { capturedResults.append($0) }
    ...
    private func makeSUT(url: URL = URL.anyURL, file: StaticString = #filePath, line: UInt = #line) -> (sut: RemoteFeedImageDataLoader, client: HTTPClientSpy) {
        let client = HTTPClientSpy()
